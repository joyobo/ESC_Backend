...
getAllActiveBubbles
            ...
            that._rest.joinConference(bubble.id, "moderator").then(function (joinResult) {
                resolve(joinResult);
            }).catch(function (err) {
    ...
    */
    ...
    _onAffiliationChanged(affiliation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._rest.getBubble(affiliation.bubbleId).then((bubbleUpdated) => {
    ...
    _onPrivilegeBubbleChanged(bubbleInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._rest.getBubble(bubbleInfo.bubbleId).then((bubbleUpdated) => {
