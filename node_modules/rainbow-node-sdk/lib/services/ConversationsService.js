...
class Conversations {
    ...
    attachHandlers() {
        let that = this;
        that.conversationEventHandler = new conversationEventHandler_1.ConversationEventHandler(that._xmpp, that, that._fileStorageService, that._fileServerService);
        that.conversationHandlerToken = [
        ...
        that.conversationHistoryHandler = new conversationHistoryHandler_1.ConversationHistoryHandler(that._xmpp, this);
        that.conversationHistoryHandlerToken = [
